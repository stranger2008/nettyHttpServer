...
STDOUT_FILE=/export/Logs/predictor/stdout.log
...
if [ -n "$BITS" ]; then
	...
	JAVA_MEM_OPTS=" -server -Xms1024m -Xmx1024m -XX:PermSize=128m -XX:SurvivorRatio=2 -XX:+UseParallelGC -Dfile.encoding=UTF-8 "
fi

echo -e "Starting the $SERVER_NAME ...\c"
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.lean.netty.http.HttpServer> $STDOUT_FILE 2>&1 &
